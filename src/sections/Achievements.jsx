    ...
    <section id="achievements" className="border-b hairline px-6 py-20">
      <div className="mx-auto max-w-6xl">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-3xl text-cream md:text-4xl">Yang Sudah Dibangun</h2>
        </Reveal>
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {items.map((item, i) => (
            <Reveal key={item.id} delay={i * 0.06} className="border-l-2 border-gold-light/40 pl-5">
